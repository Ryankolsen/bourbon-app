  ...
  if (!tastings || tastings.length === 0) {
    return (
      <View className="flex-1 bg-bourbon-900 items-center justify-center px-8">
        ...
        <Text className="text-bourbon-100 text-xl font-bold mb-2">No tastings yet</Text>
          ...
          return (
            ...
            >
              <View className="flex-row justify-between items-start mb-2">
                ...
                {item.rating !== null && (
                  <View className="bg-bourbon-600 px-3 py-1 rounded-full">
              ...
              <Text className="text-bourbon-600 text-xs mt-2">
...
function NoteRow({ label, value }: { label: string; value: string }) {
  return (
    <View className="flex-row gap-1 mb-1">
      <Text className="text-bourbon-500 text-xs w-14">{label}:</Text>
      <Text className="text-bourbon-300 text-xs flex-1" numberOfLines={2}>
        {value}
      </Text>
    </View>
  );
